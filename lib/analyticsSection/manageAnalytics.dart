import 'package:app1/analyticsSection/bestScreen.dart';
import 'package:app1/analyticsSection/salesScreen.dart';
import 'package:app1/analyticsSection/tostockScreen.dart';
...
class _AnalyticsPageState extends State<AnalyticsPage> {
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(
      ...
      title: Text('ANALYTICS REPORT', style: GoogleFonts.poppins()),
    ),
    body: screens[index],
